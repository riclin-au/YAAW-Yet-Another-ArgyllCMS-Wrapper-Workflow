...
YAAW is a deliberately simple, lightweight printer profiling wrapper using the ArgyllCMS colour
...
and is religiously committed to a KISS strategy: transparent in its operation, and written in pure
...
patch counts for each page size may be selected and the targets printed at the standard ColorMunki
defaults of 210 or 420 patches per A4 or A3 page.
